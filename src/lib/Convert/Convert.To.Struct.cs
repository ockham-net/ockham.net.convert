...
namespace Ockham.Data
{
    public static partial class Convert
    {
        ...
        /// </summary> 
        internal static T ToStruct<T>(object value, ConvertOptions options, bool ignoreError, T? valueOnError, IReadOnlyDictionary<Type, ConverterDelegate> converters) where T : struct
        {
